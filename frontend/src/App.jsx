...
function PrivateRoute({ children }) {
  ...
  if (loading) return <div className="flex items-center justify-center min-h-screen text-on-surface-variant text-lg">Loading ShieldMail...</div>;
...
function App() {
  ...
  if (loading) {
    return <div className="flex items-center justify-center min-h-screen text-on-surface-variant text-lg">Loading ShieldMail...</div>;
  }
